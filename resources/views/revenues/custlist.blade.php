                    ...
                    <div class="col-9 border-end border-1">
                        <div class="row no-gutters">
                            ...
                            <div class="col-4 text-end color">
                                <a class="fst-italic fw-bold" href="/revenues/{{ $client->id }}/create" role="button"><img src="/img/doc.png" class="img-fluid thrash" alt=""> Rev.</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-7">
                <div class="row mb-1">
                    ...
                    <div class="col-2 border-end border-1 text-center color">
                        <a href="/customers/{{ $client->id }}/warning" class="fst-italic"><img src="/img/thrash.png" class="img-fluid thrash" alt=""></a> /
                        <a href="/customers/{{$client->id}}/edit" class="fst-italic"><img src="/img/edit.png" class="img-fluid thrash" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
