...
@section('title', 'Delete Contractor')
        ...
        <div class="col-12 col-md-10 mt-5">
            <div class="row mb-2 d-flex justify-content-center">
                <div class="col-12 col-md-8 text-center">
                    <h5>You really want to <span class="text-danger fw-bold">delete</span> the following Contractor?</h5>
                    <h4 class="fw-bold">{{ $client->fname }} {{ $client->name }}</h4>
                    @if(sizeof($client->docs) >0)
                        <div class="text-left">
                            <h5 class="">There are still documents belonging to this contractor</h5>
                            <h5 class="text-danger fw-bold">They will be deleted too!</h5>
                            @foreach ($client->docs as $doc)
                                <div>{{ $doc->name }} (<a href="/expenses/{{$doc->id}}/edit">Edit</a>)</div>
                            @endforeach
                        </div>
                    @endif
                </div>
            ...
            <div class="row mb-2 d-flex mt-5 justify-content-center">
                <div class="col-12 col-md-8 text-center">
                    <a class="btn btn-danger text-light btn-sm me-1" href="/contractors/{{ $client->id }}/delete" role="button">Delete</a>
